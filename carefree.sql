-- ═══════════════════════════════════════════════════════
-- DDL — Carefree Database (Reordered for Dependencies)
-- ═══════════════════════════════════════════════════════
...
-- Patient now correctly references both Caretaker and Guardian
...
-- ── 3. Secondary Dependency Tables (Depend on Patient) ──
